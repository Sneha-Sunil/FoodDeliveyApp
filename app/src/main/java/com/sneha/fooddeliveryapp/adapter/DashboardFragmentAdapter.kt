package com.sneha.fooddeliveryapp.adapter
...
import com.sneha.fooddeliveryapp.activity.RestaurantMenuActivity
...
class DashboardFragmentAdapter(val context: Context, var itemList: ArrayList<Restaurant>) :
    ...
    override fun onBindViewHolder(holder: ViewHolderDashboard, position: Int) {
        ...
        Picasso.get().load(restaurant.restaurantImage).error(R.drawable.ic_default_image_res)
